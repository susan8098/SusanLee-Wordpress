...
function hackeryou_styles(){
	...
	wp_enqueue_style('googleFonts', 'https://fonts.googleapis.com/css?family=Source+Sans+Pro:400,300,700|Playfair+Display:400,700,900italic');
...
function susan_get_thumbnail_url($post) {
